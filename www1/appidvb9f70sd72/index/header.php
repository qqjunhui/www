...
<div class="header">
    <header>
        <div>
            <a class="mui-action-back mui-icon mui-icon-left-nav mui-pull-left" style="display:<?php if($_REQUEST['id']||$_REQUEST['sid']){echo 'inline-block';}else{echo 'none';}?>;color:#fff;"></a>
            <?php if(!$_REQUEST['id']){ ?> <span class="title">秀才新闻</span><?php }else if($_REQUEST['id']){
