...
<ul class="list">
    ...
    $uid=$_SESSION['mid'];
    $sql="select list.lid,list.ltitle,list.ltime,list.lthumb,cang.time from cang,list WHERE list.lid=cang.lid AND cang.mid=$uid";
    $result=$db->query($sql);
        ...
        <li>
            <a href="show.php?sid=<?php echo $row['lid']?>">
                <div>
                    ...
                    <div class="time"><span>新闻时间：</span><?php echo $row['ltime']?></div>
