...
<div class="mui-content">
    ...
    <button id='login' class="mui-btn mui-btn-block mui-btn-primary" type="submit" style="position: fixed;bottom: 0" mid="<?php echo $_SESSION['mid']?>" lid="<?php echo $_REQUEST['sid']?>">发布</button>
</div>
<script>
