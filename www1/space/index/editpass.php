...
<div class="mui-content">
    <form id='login-form' class="mui-input-group" action="editPassCon.php" method="post">
        <div class="mui-input-row">
            <label>旧密码</label>
            <input  type="password" class="mui-input-clear mui-input" placeholder="请输入旧密码" name="oldpass">
        </div>
        <div class="mui-input-row">
            <label>新密码</label>
            <input type="password" class="mui-input-clear mui-input" placeholder="请输入新密码" name="mpass">
        </div>

        <div class="mui-input-row">
            <label>确认密码</label>
            <input type="password" class="mui-input-clear mui-input" placeholder="再次输入密码" name="mpass1">
        </div>
        <div class="mui-input-row">
