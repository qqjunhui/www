...
if(extension_loaded('gd') && $txt ) {
	...
	$fontpath = PC_PATH.'libs'.DIRECTORY_SEPARATOR.'data'.DIRECTORY_SEPARATOR.'fonts'.DIRECTORY_SEPARATOR;
	$fontfile = isset($_GET['fonts']) && !empty($_GET['fonts']) ? $fontpath.trim($_GET['fonts']) : $fontpath.'georgia.ttf';
