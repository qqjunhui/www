...
$(function(){
    ...
    // xuanxuan(".z-content-l .z-smallimg1 img",".z-content-l .z-bigimg1 img");
    // xuanxuan(".z-content-l .z-smallimg2 img",".z-content-l .z-bigimg2 img");
    // xuanxuan(".z-content-l .z-smallimg3 img",".z-content-l .z-bigimg3 img");
    xuanxuan('.z-zi',".dian",".z-zi");
    xuanxuan('.z-zizi','.imgbox1','.z-zizi');

//    xuanxiangkaimg
    function xuanimg(xuanimg1,xuanimg2){
        $(xuanimg1).mouseover(function(){
            $(xuanimg1).removeClass('first');
            $(this).addClass('first');
            $(xuanimg2).removeClass('first');
            console.log($(this).index());
            $(xuanimg2).eq($(this).index()).addClass('first');
        })
    }
    xuanimg(".z-content-l .z-smallimg1 img",".z-content-l .z-bigimg1 img");
    xuanimg(".z-content-l .z-smallimg2 img",".z-content-l .z-bigimg2 img");
    xuanimg(".z-content-l .z-smallimg3 img",".z-content-l .z-bigimg3 img");
//    lunbo
