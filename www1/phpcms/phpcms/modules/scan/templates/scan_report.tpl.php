...
?>
	...
	foreach ($d as $vs)
	{
		echo "<fonts color='red'>".new_html_special_chars($vs)."</fonts>  ";
	}
}?></td>
		<td align="left"><?php if(isset($v['zend'])){echo '<fonts color=\'red\'>Yes</fonts>';}else{echo 'No';}?></td>
