...
?>   
	...
	<?php echo intval($info['disable']) ? '<fonts color="green">'.$info['name'].'</fonts>': '<fonts color="grey">'.$info['name'].'</fonts>'?></a><?php if($iframe['url']) { ?><a href="plugin.php?id=<?php echo $info['identification']?>" target="_blank"><img src="<?php echo IMG_PATH?>admin_img/link.png" title="iframe"></a><?php } ?>
	</td>
