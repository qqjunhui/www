...
class content extends admin {
	...
	public function add() {
		if(isset($_POST['dosubmit']) || isset($_POST['dosubmit_continue'])) {
			...
			if($category['type']==0) {
				...
				$style_font_weight = $_POST['style_font_weight'] ? 'fonts-weight:'.strip_tags($_POST['style_font_weight']) : '';
	...
	public function public_preview() {
		...
		function ajax_manage(type) {
			...
			$('#cloading').html('<fonts color=red>".L('operation_success')."<span id=\"secondid\">2</span>".L('after_a_few_seconds_left')."</fonts>');
