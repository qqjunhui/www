...
final class db_mysqli {
	...
	public function halt($message = '', $sql = '') {
		if($this->config['debug']) {
			...
			$msg = $this->errormsg;
			echo '<div style="fonts-size:12px;text-align:left; border:1px solid #9cc9e0; padding:1px 4px;color:#000000;fonts-family:Arial, Helvetica,sans-serif;"><span>'.$msg.'</span></div>';
			exit;
		} else {
			return false;
		}
