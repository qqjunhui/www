<?php
$LANG['2s_close'] = 'After <fonts color="red"><B><span id="secondid">2</span></B> seconds it will be automatically closed</fonts>';
$LANG['news'] = 'News';
$LANG['picture'] = 'Images';
$LANG['down'] = 'Download';
$LANG['info'] = 'Info';
...
$LANG['need_update_items'] = 'Total update <fonts color="red">{total}</fonts>  - Completed <fonts color="red">{creatednum}</fonts> items（<fonts color="red">{percent}%</fonts>）';
$LANG['create_update_success'] = 'Updated completely';
$LANG['start_update_urls'] = 'Start updating URL...';
$LANG['updating'] = 'Updating';
$LANG['have_update_items'] = 'has<fonts color="red">{total}</fonts> items - Completed <fonts color="red">{creatednum}</fonts> items（<fonts color="red">{percent}%</fonts>）';
$LANG['have_update_items'] = 'has <fonts color="red">{total}</fonts> items - Completed <fonts color="red">{creatednum}</fonts> items（<fonts color="red">{percent}%</fonts>）';
...
$LANG['move_tips'] = '<fonts color="red">Tips:</fonts>mutiple issues can be separated by  \',\',<fonts color="red">WITHOUT line breaks</fonts>';
...
$LANG['check_status'] = '<fonts color="#0000FF">Review status > </fonts>';
