...
$LANG['unpay'] = '<fonts color="red" class="onError">Not paid</fonts>';
$LANG['succ'] = '<fonts color="green" class="onCorrect">Successful</fonts>';
$LANG['failed'] = 'Failed to transact';
$LANG['error'] = 'Transaction error';
$LANG['progress'] = '<fonts color="orange" class="onTime">Processing</fonts>';
$LANG['timeout'] = 'Transaction is timeout';
$LANG['cancel'] = 'Cancelled';
$LANG['waitting'] = '<fonts color="orange" class="onTime">Pending payment</fonts>';
