...
$LANG['gd_unsupport'] = '<fonts color="red">不支持</fonts>';
$LANG['gd_support'] = '<fonts color="green">支持</fonts>';
...
$LANG['setting_attachment_stat_desc'] = '<fonts color="gray">记录附件使用状态 ，删除文章时同步删除附件。注意: 本功能会加重服务器负担</fonts>';
$LANG['setting_category_ajax_desc'] = '<fonts color="gray">默认为0,即直接显示栏目列表。当栏目层级较多时，可设置首次加载层级，其余使用异步加载，一般设置为2-3</fonts>';
...
$LANG['category_type_page'] = '<fonts color="blue">单网页</fonts>';
$LANG['category_type_link'] = '<fonts color="red">外部链接</fonts>';
...
$LANG['readpoint'] = '点';
$LANG['readpoint_tips'] = '（会员在此栏目下查看信息时，该信息默认的收费），当这里设置为0时，发布页设置了，可只对设置的文章收费，<fonts color="red">生成静态时收费无效</fonts>';
$LANG['money'] = '元';
...
$LANG['batch_add_tips'] = '例如：<br><fonts color="#959595">国内新闻|china<br>国际新闻|world<br></fonts>竖线以及后面的英文名可留空，默认会自动生成栏目的拼音';
