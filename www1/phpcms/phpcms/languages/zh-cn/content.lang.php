<?php
$LANG['2s_close'] = '<fonts color="red"><B><span id="secondid">2</span></B> 秒后自动关闭</fonts>';
$LANG['news'] = '新闻';
$LANG['picture'] = '图片';
$LANG['down'] = '下载';
$LANG['info'] = '信息';
...
$LANG['need_update_items'] = '共需更新 <fonts color="red">{total}</fonts> 条信息 - 已完成 <fonts color="red">{creatednum}</fonts> 条（<fonts color="red">{percent}%</fonts>）';
$LANG['create_update_success'] = '更新完成！ ...';
$LANG['start_update_urls'] = '开始更新URL ...';
$LANG['updating'] = '正在更新';
$LANG['have_update_items'] = '有 <fonts color="red">{total}</fonts> 条信息 - 已完成 <fonts color="red">{creatednum}</fonts> 条（<fonts color="red">{percent}%</fonts>）';
$LANG['have_update_items'] = '有 <fonts color="red">{total}</fonts> 条信息 - 已完成 <fonts color="red">{creatednum}</fonts> 条（<fonts color="red">{percent}%</fonts>）';
...
$LANG['move_tips'] = '<fonts color="red">Tips:</fonts>多个问题ID请用\',\'隔开，<fonts color="red">注意不要换行</fonts>';
...
$LANG['check_status'] = '<fonts color="#0000FF">当前审核状态 ＞</fonts>';
...
$LANG['videoes_num'] = '考虑网络因素，请每次添加、修改时新加视频的数量不超过 <fonts color="red">5</fonts> 个</div>';
