...
$LANG['unpay'] = '<fonts color="red" class="onError">交易未支付</fonts>';
$LANG['succ'] = '<fonts color="green" class="onCorrect">交易成功</fonts>';
$LANG['failed'] = '交易失败';
$LANG['error'] = '交易错误';
$LANG['progress'] = '<fonts color="orange" class="onTime">交易处理中</fonts>';
$LANG['timeout'] = '交易超时';
$LANG['cancel'] = '交易取消';
$LANG['waitting'] = '<fonts color="orange" class="onTime">等待付款</fonts>';
...
$LANG['chinabank'] = '网银在线';
$LANG['chinabank_tip'] = '网银在线与中国银行、中国工商银行、中国农业银行、中国建设银行、招商银行等国内各大银行，以及VISA、MasterCard、JCB等国际信用卡组织保持了长期、紧密、良好的合作关系。<a href="http://www.chinabank.com.cn" target="_blank"><fonts color="red">立即在线申请</fonts>';
$LANG['chinabank_account'] = '网银在线商户号';
$LANG['chinabank_key'] = '网银在线MD5私钥';

$LANG['sndapay'] = '盛付通';
$LANG['sndapay_tip'] = '盛付通是盛大网络创办的中国领先的在线支付平台，致力于为互联网用户和企业提供便捷、安全的支付服务。通过与各大银行、通信服务商等签约合作，提供具备相当实力和信誉保障的支付服务。<a href="http://www.shengpay.com/HomePage.aspx?tag=phpcms" target="_blank"><fonts color="red">立即在线申请</fonts>';
