...
<link rel="stylesheet" type="text/css" href="<?php echo CSS_PATH;?>mycss/qindex.css"/>
<script src='<?php echo JS_PATH;?>myjs/qindex.js'></script>
<div class="container-fluid">
    <div class="row hidden-sm hidden-xs hidden-md z-bannerbig">
        <!--大屏banner-->
        <div class="z-banner z-bannerbig hidden-sm hidden-xs hidden-md">
            <a class="first-two tutu">
                <div class="zhezhao"></div>
                <img class="qxiehou col-lg-3 col-lg-offset-1" src="<?php echo IMG_PATH;?>img/qxiehou.png" alt=""/>
                <img class="qzi col-lg-5 col-lg-offset-3 " src="<?php echo IMG_PATH;?>img/qzi.png" alt=""/>
    ...
    <div class="row hidden-lg hidden-xs z-bannermidden">
        <!--<!--中屏banner-->
        <div class="z-banner z-bannermidden hidden-lg hidden-xs">
            <a class="first-two tutu">
                <div class="zhezhao"></div>
                <img class="qxiehou col-md-4 col-md-offset-1" src="<?php echo IMG_PATH;?>img/qxiehou.png" alt=""/>
                <img class="qzi col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-2" src="<?php echo IMG_PATH;?>img/qzi.png" alt=""/>
    ...
    <div class="row hidden-sm hidden-md hidden-lg z-bannersmall">
       <!-- <!--小屏banner-->
        <div class="z-banner z-bannersmall hidden-sm hidden-md hidden-lg">
            <a class="first-two tutu">
                <div class="zhezhao"></div>
                <img class="qxiehou col-xs-6 col-lg-4 col-lg-offset-1" src="<?php echo IMG_PATH;?>img/qxiehou.png" alt=""/>
                <img class="qzi col-xs-10 col-md-6 col-md-offset-3" src="<?php echo IMG_PATH;?>img/qzi.png" alt=""/>
            ...
            <a class="tutu">
                <div class="zhezhao"></div>
                <img class="qxiehou col-xs-6 col-lg-4 col-lg-offset-1" src="<?php echo IMG_PATH;?>img/qxiehou.png" alt=""/>
                <img class="qzi col-xs-10 col-lg-6 col-lg-offset-2" src="<?php echo IMG_PATH;?>img/qzi.png" alt="" />
                <div class="rect1 col-xs-8 "></div>
            </a>
            <a class="tutu">
                <div class="zhezhao"></div>
...
<div class="container-fluid">
    <div class="row">
        <div class="bg hidden-md hidden-sm hidden-xs">
            <img src="<?php echo IMG_PATH;?>img/qkabg.png" alt="" />
        </div>
    </div>
    <div class="row">
        <div class="pingpai">
            <img src="<?php echo IMG_PATH;?>img/qpingpai.png" alt="" class='col-xs-12 hidden-lg hidden-md hidden-sm'/>
            <img src="<?php echo IMG_PATH;?>img/qpingpai.png" alt="" class='hidden-xs'/>
            <div class="line"></div>
            <ul class='zi'>
                <li><span>源</span></li>
    ...
    <div class="row">
        <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=17234d5a1f0d42e18bb2cbd2c69e927c&action=lists&siteid=%24siteid&catid=14&order=listorder+ASC&num=25&moreinfo=1&page=%24page\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$pagesize = 25;$page = intval($page) ? intval($page) : 1;if($page<=0){$page=1;}$offset = ($page - 1) * $pagesize;$content_total = $content_tag->count(array('siteid'=>$siteid,'catid'=>'14','order'=>'listorder ASC','moreinfo'=>'1','limit'=>$offset.",".$pagesize,'action'=>'lists',));$pages = pages($content_total, $page, $pagesize, $urlrule);$data = $content_tag->lists(array('siteid'=>$siteid,'catid'=>'14','order'=>'listorder ASC','moreinfo'=>'1','limit'=>$offset.",".$pagesize,'action'=>'lists',));}?>
        <?php var_dump($data)?>
        <div class="tese col-lg-12 col-xs-12 col-md-12 col-sm-12 ">
            <img src="<?php echo IMG_PATH;?>img/qtese.png" alt=""  class='col-xs-12 hidden-lg hidden-md hidden-sm'/>
            <img src="<?php echo IMG_PATH;?>img/qtese.png" alt=""  class='hidden-xs'/>
            <!--小屏-->
          ...
          <!--大屏-->
            ...
            <div class="row check check1 col-xs-12 hidden-md hidden-sm hidden-lg">
                <ul class='boxmian'>
                    <li class="col-xs-4">
                        <img src="<?php echo IMG_PATH;?>img/qyang.png" alt="" class='col-xs-12' />
                        <div>
                            <p>阳春面</p>
                    ...
                    <li class="col-xs-4">
                        <img src="<?php echo IMG_PATH;?>img/qkapian2.png" alt="" class='col-xs-12'/>
                        <div>
                            <p>兰州拉面</p>
                    ...
                    <li class="col-xs-4">
                        <img src="<?php echo IMG_PATH;?>img/qka3.png" alt=""  class='col-xs-12'/>
                        <div>
                            <p>云吞面</p>
            ...
            <div class="row check check2 hidden-md hidden-sm hidden-xs col-lg-8 col-lg-offset-2">
                <ul class='boxmian'>
                    <li>
                        <img src="<?php echo IMG_PATH;?>img/qyang.png" alt="" />
                        <div>
                            <p>阳春面</p>
                    ...
                    <li>
                        <img src="<?php echo IMG_PATH;?>img/qkapian2.png" alt="" />
                        <div>
                            <p>兰州拉面</p>
                    ...
                    <li>
                        <img src="<?php echo IMG_PATH;?>img/qka3.png" alt="" />
                        <div>
                            <p>云吞面</p>
                            <p>WONTON NOODLES</p>
                            <p class='hidden-xs hidden-sm hidden-md'>CERTIFERD</p>
            ...
            <img class="hidden-lg" src="<?php echo IMG_PATH;?>img/qjiaying.png" alt="" />
        </div>
        <?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
    </div>
    <div class="row">
        <div class="jia">
            <img src="<?php echo IMG_PATH;?>img/qjiamen.png" alt=""  class='col-xs-12 hidden-lg hidden-md hidden-sm'/>
            <img src="<?php echo IMG_PATH;?>img/qjiamen.png" alt=""  class='hidden-xs'/>
            <p class="hidden-lg">标准店 STANDADR SHOP</p>
            <div class="contianer-fluid hidden-lg imgbox1">
                <img class="z-x-banner first-two" src="<?php echo IMG_PATH;?>img/qjia3.png" alt=""/>
                <img class="z-x-banner" src="<?php echo IMG_PATH;?>img/qjia1.png" alt=""/>
                <img class="z-x-banner" src="<?php echo IMG_PATH;?>img/qjia2.png" alt=""/>
                <img class="z-x-banner" src="<?php echo IMG_PATH;?>img/qjia3.png" alt=""/>
                <a class="diandian1">
            ...
            <!--<img class="hidden-lg hidden-md hidden-sm" src="<?php echo IMG_PATH;?>img/qjiaying.png" alt="" />-->
            <ul class="box hidden-md hidden-sm hidden-xs col-lg-8 col-lg-offset-2">
                <li>
                    <section>
                        <img src="<?php echo IMG_PATH;?>img/qjia1.png" alt=""  class="col-lg-5"/>
                        <div class="col-lg-7">
                            <span>01</span>
                            <span>标准店</span>
                ...
                <li class='first'>
                    <section>
                        <img src="<?php echo IMG_PATH;?>img/qjia3.png" alt="" />
                        <div>
                            <span>02</span>
                            <span>旗舰店</span>
                            <span>STANDARD SHOP</span>
                ...
                <li>
                    <section>
                        <img src="<?php echo IMG_PATH;?>img/qjia3.png" alt=""   class="col-lg-5"/>
                        <div class="col-lg-7">
                            <span>03</span>
                            <span>形象店</span>
                            <span>STANDARD SHOP</span>
    ...
    <div class="row">
        <div class="tui col-xs-12 col-sm-12 col-md-12">
            <img src="<?php echo IMG_PATH;?>img/qtuiguang.png" alt=""  class='col-xs-12 hidden-lg hidden-md hidden-sm'/>
            <img src="<?php echo IMG_PATH;?>img/qtuiguang.png" alt=""  class='hidden-xs'/>
            <ul class="hidden-xs hidden-sm hidden-md col-lg-8 col-lg-offset-2 list">
                <li>
                    <div class="meng first">
                        <div class="one">
                            <img src="<?php echo IMG_PATH;?>img/qjia2.png" alt="" class=""/>
                            <div>
                        ...
                        <ul class="two">
                            <li>
                                <img src="<?php echo IMG_PATH;?>img/qping3.png" alt="" />
                                <div>
                                    <span>NET DELICACY</span>
                                    <span>山西美食网</span>
                            ...
                            <li>
                                <img src="<?php echo IMG_PATH;?>img/qping2.png" alt="" />
                                <div>
                                    <span>NET DELICACY</span>
                                    <span>山西美食网</span>
                    ...
                    <div class="meng">
                        <div class="one">
                            <img src="<?php echo IMG_PATH;?>img/qping1.png" alt="" />
                            <div>
                                <span>NET DELICACY</span>
                                <span>山西美食网</span>
                        ...
                        <ul class="two">
                            <li>
                                <img src="<?php echo IMG_PATH;?>img/qjia1.png" alt="" />
                                <div>
                                    <span>NET DELICACY</span>
                                    <span>山西美食网</span>
                    ...
                    <div class="meng">
                        <div class="one">
                            <img src="<?php echo IMG_PATH;?>img/qjia2.png" alt="" />
                            <div>
                                <span>NET DELICACY</span>
                                <span>山西美食网</span>
                                <p>2016年刚刚拉开帷幕，知名山西美食品牌个消息将...</p>
            ...
            <ul class="mei mei1 col-xs-12 hidden-lg hidden-md hidden-sm">
                <li>
                    <img src="<?php echo IMG_PATH;?>img/qping1.png" alt="" class="col-xs-4"/>
                ...
                <li>
                    <img src="<?php echo IMG_PATH;?>img/qping2.png" alt=""  class="col-xs-4"/>
                    <span class="col-xs-8 col-xs-offset-4">NET DELICACY</span>
                    <span class="col-xs-8 col-xs-offset-4">山西美食网</span>
                    <p class="col-xs-8 col-xs-offset-4 hidden-md hidden-sm">2016年刚刚拉开帷幕，一碗...</p>
                ...
                <li>
                    <img src="<?php echo IMG_PATH;?>img/qping3.png" alt=""  class="col-xs-4"/>
                    <span class="col-xs-8 col-xs-offset-4">NET DELICACY</span>
                    <span class="col-xs-8 col-xs-offset-4">山西美食网</span>
                    <p class="col-xs-8 col-xs-offset-4 hidden-md hidden-sm">2016年刚刚拉开帷幕，一碗...</p>
    ...
    <div class="row">
        <div class="xin">
            <img src="<?php echo IMG_PATH;?>img/qxin.png" alt=""  class='col-xs-12 hidden-lg hidden-md hidden-sm'/>
            <img src="<?php echo IMG_PATH;?>img/qxin.png" alt=""  class='hidden-xs'/>
            <section class='hidden-xs hidden-sm hidden-md col-lg-8 col-lg-offset-2'>
                <img src="<?php echo IMG_PATH;?>img/qxin1.png" alt="" class="col-lg-6" />
                <ul class="col-lg-6">
                    <li>
                        <p>餐饮业目前什么最流行</p>
                        <span>2016-12-09</span>
                        <p>近几年，一碗面在中国发展可谓是迅猛，也相当普及，原因是除了面食都爱吃，而实惠的...</p>
                        <img src="<?php echo IMG_PATH;?>img/qxin2.png" alt="" />
                    </li>
                    <li class='first'>
                        <p>不把顾客当上帝，而把顾客当朋友</p>
                        <span>2016-12-09</span>
                        <p>总部在‘仙芋诱惑’的项目中，创造性的打出了‘不把顾客当上帝，而把顾客当朋友’的口号，最早...</p>
                        <img src="<?php echo IMG_PATH;?>img/qxin3.png" alt="" />
                    </li>
                    <li>
                        <p>企业文化新标杆，融洽团队</p>
                        <span>2016-12-09</span>
                        <p>近几年，一碗面在中国发展可谓是迅猛，也相当普及，原因是除了面食都爱吃，而实惠的...</p>
                        <img src="<?php echo IMG_PATH;?>img/qxin4.png" alt="" />
                    </li>
                </ul>
            </section>
            ...
            <div class="imgboxa hidden-lg col-xs-12">
                <img src="<?php echo IMG_PATH;?>img/qxin2.png" alt="" class="col-xs-4">
                <img src="<?php echo IMG_PATH;?>img/qxin3.png" alt="" class="col-xs-4"/>
                <img src="<?php echo IMG_PATH;?>img/qxin4.png" alt="" class="col-xs-4"/>
            </div>
    ...
    <div class="row continer-fluid">
        <ul class="lianxi hidden-md hidden-sm hidden-xs">
            <li class='col-lg-4'>
                <img src="<?php echo IMG_PATH;?>img/qyou.png" alt="" />
                <p>1102345678@qq.com</p>
            </li>
            <li class='col-lg-4'>
                <img src="<?php echo IMG_PATH;?>img/qdixhi.png" alt="" />
                <p>中国陕西省太原市平阳路48号</p>
            </li>
            <li class='col-lg-4'>
                <img src="<?php echo IMG_PATH;?>img/qdianhua.png" alt="" />
                <p>0354-1234567</p>
            </li>
        </ul>
